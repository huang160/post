  ...
  <div style="text-align: left;">
    ...
    <div class="container" style="margin-top: 83px;padding: 1px 15px;">
      ...
      >
        ...
        <div style="width: 54%;height: 45px;margin-top: 3px;">
          <div style="display: flex;flex-direction: row;">
            <div class="van-ellipsis" style="color: #000;display: flex;flex-direction: row;">
              ...
              <div class="van-ellipsis" style="width: 80%;font-size: 12px;color: #969799;margin: 3px 0 0 2px;">
                {{chat.users[msg.to === user._id ? msg.from : msg.to].job}}
              </div>
            </div>
          </div>
        ...
        <div style="width: 45%;text-align: right;font-size: 12px;color: #969799;">
...
import {NavBar, Tag, Image, Badge, Empty, Toast} from 'vant'
